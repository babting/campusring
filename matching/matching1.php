...
<div class="container">
    <div class="review_star_sort">
        <div class="review_topstar">
    ...
    <div>
        <div class="">
            ...
            <div class="drop_btn">접기 <i class="fas fa-sort-up"></i></div>

            <div class="review_sort">
                <ul>
                    <li><span>베스트순</span></li>
                    <li><span>|</span></li>
                    <li><span>최신순</span></li>
                </ul>
            </div>
            ...
            <div class="review_page">
                ...
                <div class="review_group">
                    ...
                    <div class="review_star_count">
                        ...
                        <i class="fas fa-star fa-1x "></i>
                        <i class="fas fa-star fa-1x "></i>
                        <span class="review_date">2021.04.11</span>
                    </div>

                    <!--리뷰내용을 보여주는 디브 임의 로 추가했어요-->
                    <div class="review_context">내용</div>
